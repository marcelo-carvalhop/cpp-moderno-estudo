...
Uma dependência cíclica é um sintoma de um design falho e tem consequências desastrosas:
    ...
    1. *Compilação Impossível*: Torna impossível compilar os componentes de forma isolada. A e B devem ser compilados juntos, sempre.
    2. *Fusão de Componentes*: A e B deixam de ser componentes independentes. Eles se fundem em um "super-componente" emaranhado, eliminando os benefícios da modularidade.
    3. *Teste Dificultado*: É impossível testar A sem trazer todo o B (e vice-versa), aumentando drasticamente a complexidade dos testes unitários.
...
[[../antigos/capitulo_18.org][(Revisado e Aprofundado): Dominando o Modelo Clássico — Headers, Linkagem e o Pré-processador]]

[[../antigos/capitulo_19.org][A Arquitetura Moderna — Módulos, Partições e Interfaces]]

[[../antigos/capitulo_21_errado.org][A Anatomia de um Projeto CPP Canônico — Estrutura de Diretórios e Filosofia]]

[[../antigos/capitulo_21.org][A Filosofia da Estrutura de Diretórios — Um Blueprint para a Clareza]]

[[../antigos/capitulo_22.org][Gerenciamento de Dependências — Construindo Sobre os Ombros de Gigantes]]
