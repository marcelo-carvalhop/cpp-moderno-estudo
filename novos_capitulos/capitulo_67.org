...
Onde ... representa memória não relacionada. Para atravessar a lista, a CPU:
  ...
  1. Lê o Nó 1. Provavelmente um cache miss. A cache line contendo o Nó 1 é carregada.
  2. Segue o ponteiro next para o Nó 2. O endereço do Nó 2 é imprevisível.
  3. Lê o Nó 2. Quase certamente outro cache miss. Uma cache line completamente diferente é carregada.
  4. Repete o processo, sofrendo um cache miss a cada passo.
...
Os dados são perfeitamente contíguos. Ao atravessar o vetor, a CPU:
    ...
    1. Lê o Objeto 1. Provavelmente um cache miss. A cache line contendo os Objetos 1 a N é carregada.
    2. Acessa o Objeto 2. Um cache hit garantido, pois já está na cache line.
    3. Acessa os Objetos 3 a N. Todos cache hits.
...
** Leituras de Referência:
  ...
  - [[../complementos/capitulo_67_oma.org][*Fog, Agner - "Optimizing Software in C++"*: O Capítulo 9, "Optimizing memory access"]], detalha o impacto do layout de dados no desempenho da CPU.
