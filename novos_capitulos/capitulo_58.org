...
A ideia é dividir uma classe em duas:
    ...
    1. *O Objeto Humilde*: A parte que interage diretamente com o mundo exterior. Ele contém o mínimo de lógica possível, sendo "humilde" o suficiente para não precisar de testes de unidade. Sua única tarefa é pegar os dados brutos e passá-los para o Presenter/Controller.

    2. *O Presenter/Controller/ViewModel*: A parte que contém toda a lógica de apresentação, formatação e decisão. Ele não sabe nada sobre a GUI ou a rede; ele opera em tipos de dados puros e é 100% testável.
