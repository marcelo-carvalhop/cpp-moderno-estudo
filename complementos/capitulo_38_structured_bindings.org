* Structured bindings: desestruturação genérica
...
** A Solução: Nomes Diretos para Membros
...
** Como Funciona: A Metaprogramação nos Bastidores
...
** Estendendo o Protocolo para Tipos Personalizados
